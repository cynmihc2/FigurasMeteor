...
/*
var num = Slices.find({}).count();
console.log("NUM ES: "+num);

if(Slices.find({}).count() == 0){
	console.log("Entra a if de slices");
	console.log("Slices.find().count() es: "+Slices.find({}).count());
	...
	console.log("Creacion de Array");
	var arreglo= Figuras.find({}, {sort: {timestamp: 1} });
	
	// for(i = 0, i){

	// }
	console.log("long es: "+arreglo.length);
